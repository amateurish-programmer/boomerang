...
/** A separate durable inbox; explicitly Closeable because older SQLiteOpenHelper lacks that interface. */
class NotificationRepository(context: Context) : SQLiteOpenHelper(context.applicationContext, "notification_inbox.db", null, 1), Closeable {
